...
static public class BD
{
    ...
    public static void AgregarDeportista(string apellido, string nombre, DateTime fechaNacimiento, string foto, int idPais, int idDeporte)
    {
	    ...
	    {
		    db.Execute(sql, new {pApellido = apellido, pNombre = nombre, pFecha = fechaNacimiento, pFoto = foto, pPais = idPais, pDeporte = idDeporte});
	    }
    }
